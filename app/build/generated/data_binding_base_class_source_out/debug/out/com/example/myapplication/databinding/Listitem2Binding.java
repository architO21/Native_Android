...
public final class Listitem2Binding implements ViewBinding {
  ...
  private Listitem2Binding(@NonNull ConstraintLayout rootView, @NonNull TextView name1,
      @NonNull TextView price1) {
  ...
  public static Listitem2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.listitem2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static Listitem2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Listitem2Binding((ConstraintLayout) rootView, name1, price1);
    }
